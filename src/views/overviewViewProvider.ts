...
import type { ExtensionToWebviewMessage, ViewState, WebviewToExtensionMessage } from '../shared/types';
    ...
    <style>
      ...
      * {
      ...
      .graph-wrap {
        ...
        border: 1px solid var(--panel-border);
        background:
          radial-gradient(circle at center, color-mix(in srgb, var(--accent) 10%, transparent), transparent 62%),
